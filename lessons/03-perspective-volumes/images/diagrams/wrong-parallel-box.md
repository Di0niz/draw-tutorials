...
слева `wrong-parallel-box.png` (как не надо), справа `right-converging-box.png`
(как надо). У правой пластины есть отдельное описание `right-converging-box.md`.
Одно описание на обе пластины — они рисуются одной парой, в одном кадре,
масштабе и ракурсе, иначе сравнение не работает.
...
**Статус:** `wrong-parallel-box.png` и `right-converging-box.png` — карандашные

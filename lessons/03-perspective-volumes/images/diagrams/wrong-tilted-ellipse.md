...
`compare`: слева `wrong-tilted-ellipse.png` (как не надо), справа
`right-axis-ellipse.png` (как надо). У правой пластины есть отдельное описание
`right-axis-ellipse.md`. Одно описание на обе пластины — у них общий кадр,
общий масштаб и одна и та же ось цилиндра, иначе сравнение не читается.
...
**Статус:** `wrong-tilted-ellipse.png` и `right-axis-ellipse.png` — карандашные
